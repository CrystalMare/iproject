            ...
            $buffer['veiling'] .= <<<"END"
                <div class ="col-md-12 col-xs-12">
                    ...
                    <div class ="col-md-3 col-xs-3">
                        <a href="?page=product&veiling=$veiling[voorwerpnummer]" class="btn btn-warning bodplaatsen" id="$veiling[voorwerpnummer]" data-id=$veiling[voorwerpnummer] >Ga naar veiling</a>
                    </div>
                </div>
END;
